...
if (isset($_POST['submit'])) {
    while ($row = mysqli_fetch_assoc($candidates)) {
        ...
        $judges->insertData('qa_male', ['male_candidate_id'=>$id, 'spontaneity'=>$spontaneity, 'substance'=>$substance, 'delivery'=>$delivery]);
    }
...
<body>
    <nav class="top-nav">
        ...
        <h3 class="title-category">Question and Answer Male 25%</h3>
    </nav>
