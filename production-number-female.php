...
if (isset($_POST['submit'])) {
    while ($row = mysqli_fetch_assoc($candidates)) {
        ...
        $judges->insertData('female_production_number', ['female_candidate_id'=>$id, 'poise_and_bearing'=>$poise_and_bearing, 'fitness'=>$fitness, 'uniqueness_and_style'=>$uniqueness_and_style]);
    }
